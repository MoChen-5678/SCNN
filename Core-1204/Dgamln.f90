...
!         DGAMLN COMPUTES THE NATURAL DLOG OF THE GAMMA FUNCTION FOR
...
!           DGAMLN  - NATURAL DLOG OF THE GAMMA FUNCTION AT Z.NE.0.0D0
!           IERR    - ERROR FLAG
...
!***END PROLOGUE  DGAMLN
     ...
     & T1, WDTOL, Z, ZDMY, ZINC, ZM, ZMIN, ZP, ZSQ , DGAMLN !, D1MACH
